...
int main()
{
    ...
    char pass[50];
    cout<<endl<<"         Online Voting System / College President Election System                   "<< endl;
    ...
    if(NumCan>1)
    {
        ...
        cin>>pass;
        while(strcmp(pass,"notdecided")!=0)
        {
          cout<< endl;
        ...
        for(i=1; i<=NumStu; i++)
            ...
            for(j=1; j<=NumCan; j++)
            {
                ...
                {
                    cout<<endl;
                    cout<<endl<<"           Congratulations "<<CanName[j]<<". You are Elected as our new President."<< endl;
                    break;
                }
            }
            cout<<endl;
